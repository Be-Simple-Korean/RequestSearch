 ...
 * 옵션 항목 표시 ui수정 다이얼로그
 */
public class CopySelectOptionDialog extends Dialog {
    ...
    public CopySelectOptionDialog(@NonNull Context context, String sort, String d_range) {
        super(context);
        this.sort = sort;
    ...
    private void setRecyclerViewSort(int sortIndex) {
        ...
        optionSortAdapter.setOnItemClick(new OnItemClickListener() {
            ...
            public void setOnItemClick(View v,int position) {
                onDimissListener.onDismissed(CopySelectOptionDialog.this,position,false);
            }
        });
    ...
    private void setRecyclerViewRange(int rangeIndex) {
        ...
        optionSortAdapter.setOnItemClick(new OnItemClickListener() {
            @Override
            public void setOnItemClick(View v,int position) {
                onDimissListener.onDismissed(CopySelectOptionDialog.this,position,true);
            }
        });
        recyclerView.setAdapter(optionSortAdapter);
    }
